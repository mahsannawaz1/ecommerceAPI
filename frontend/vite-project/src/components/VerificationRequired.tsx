        ...
        <Container fixed sx={{marginY:5}}>
            ...
            <Box paddingX={8}>
                ...
                <Stack spacing={2} >
                    ...
                    <Typography sx={{color:'var(--link)',fontSize:14}}>We've sent a verification email to <a style={{color:'rgb(168, 168, 168) !important'}} href={`mailto:${email}`}>{email}</a></Typography>
